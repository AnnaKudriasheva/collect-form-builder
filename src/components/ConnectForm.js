    ...
    <> 
      ...
      <Collapse className="form-builder-collapse" accordion>
        <Panel header="Manual integration with VGS" key="1">
          ...
          <p>Download the code generated by the Form Builder for your form and paste it into your application.</p>
          <Button className="mb-2" onClick={handleCodeDownload}>Download Code</Button>
          <p>Download YAML file and <a href={LINKS.YAML_IMPORT} target="_blank">import into the Dashboard</a> manually.</p>
          <Button onClick={handleYAMLDownload}>Download YAML file</Button>
        </Panel>
      </Collapse>
      <>
      </>
